...
<html lang="es">
    ...
    <head>
        ...
        <title>Asignación de Delivery</title>
        <!-- Bootstrap Core CSS -->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="white-box">
                                ...
                                <h3 class="box-title">PEDIDOS PARA ASIGNAR <span class="badge badge-success">DELIVERY</span></h3>
                                            ...
                                            <tbody>              
                                                ...
                                                <tr>
                                                    ...
                                                    <form class="form-group" action="modificar_delivery2.php" method="post">
                                                        ...
                                                        <td>
                                                            <input class="form-control form-control-sm" type="text" name="npedido" id="npedido"  placeholder="coloque # Pedido">
