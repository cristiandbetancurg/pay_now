                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6 col-xs-12">
                            <div class="white-box analytics-info">
                                <h3 class="box-title">Reporte Total de Pagos</h3>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12">
                            <div class="white-box analytics-info">
                                <h3 class="box-title">Total Pagos Abiertos</h3>
                                <ul class="list-inline two-part">
                                    <li>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part">
                                    ...
                                    <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info">1</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody>              
                                                ...
                                                <tr>
                                                    ...
                                                    <form class="form-group" action="modificar.php" method="post">
                                                        ...
                                                        <td><input class="form-control form-control-sm" type="text" name="npedido" id="npedido"  placeholder="col   oque # Pedido"></td>                                                        
